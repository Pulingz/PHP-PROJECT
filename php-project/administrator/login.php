...
<html lang="en">
    <head>
        ...
        <title>Page Title - CMS LOGIN FORM</title>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <form action="" method="post">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" type="text" placeholder="Enter Username anda di sini" name="userku" />
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword">Password</label>
                                                <input class="form-control py-4" id="inputPassword" type="password" placeholder="Enter password" name="passku" />
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <input class="btn btn-primary" type="submit" name="masuk" value="LOGIN">
                                            </div>
                                        </form>
                                    </div>
